#!/usr/anaconda3/env/dadi/bin/python
# -*- coding: utf-8 -*-
...
def IM2M(params, ns, pts):
    """
    Split into two populations, with symmetric migration and two migration rates.
    nu1: Size of population 1 after split.
    nu2: Size of population 2 after split.
    T: Time in the past of split (in units of 2*Na generations)
    m: Migration rate between populations (2*Na*m)
    me: Reduced effective migration rate
    P: The proportion of the genome evolving neutrally
    """
    nu1, nu2, m, me, P, T = params
    ...
    phiN = Integration.two_pops(phiN, xx, T, nu1, nu2, m12=m, m21=m)
    ...
    phiI = Integration.two_pops(phiI, xx, T, nu1, nu2, m12=me, m21=me)
